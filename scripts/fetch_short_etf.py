...
fetch_short_etf.py
------------------
yfinance를 사용해 BITI / ETHD / SOLI / MSTZ 의 최근 정규장 종가를 수집하고
data/short-etf-data.json 에 저장한다.
...
OUT_FILE = OUT_DIR / "short-etf-data.json"
...
def main():
    ...
    output = {
        ...
        # 구조: { "BITI": { "close": 12.34, "date": "2026-03-20" }, ... }
        "prices": prices,
    }
